<%@ Page Language="C#" AutoEventWireup="true" CodeFile="studentModify.aspx.cs" Inherits="page_studentModify" %>
    ...
    <form id="form1" runat="server">
        <table class="table table-dark" style="text-align:center;">
            ...
            <tbody>
                <tr>
                    <td>
                        <asp:Label ID="Label1" runat="server" Text="身份证号"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label5" runat="server" Text="民族"></asp:Label></td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label7" runat="server" Text="手机号"></asp:Label></td>
                    <td>
                        <asp:TextBox ID="TextBox7" runat="server"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="Label8" runat="server" Text="邮箱"></asp:Label></td>
                    <td>
