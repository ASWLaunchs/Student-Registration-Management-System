<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin.aspx.cs" Inherits="page_admin" %>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#">
                                    <button id="dataStatistics" type="button" class="btn btn-primary btn-lg">
                                        ...
                                        <span style="font-size: 14px; letter-spacing: 2px; text-indent: 4px">学生信息管理</span>
                                    </button>
                                </a>
                            </li>
                            <li class="nav-item">
